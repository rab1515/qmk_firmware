...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(KC_ESC, KC_GRV, KC_TAB, KC_CAPS, KC_LSFT, KC_LCTL, KC_1, KC_Q, SOCD_A, KC_Z, KC_9, KC_ENT, KC_2, SOCD_W, SOCD_S, KC_4, KC_L, KC_E, SOCD_D, KC_V, KC_8, KC_SPC, KC_X, KC_7, KC_R, KC_F, KC_H, KC_3, KC_5, LT(1,KC_I), KC_K, KC_G, KC_N, KC_B, KC_GRV, KC_C),
